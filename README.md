...
**Google Colab:** step-by-step notebook using the same API — [Parakeet AVASR inference (Colab)](https://colab.research.google.com/drive/1PkLniQwaxmhCeUfpPLrWzGYm3HoHOwbO?usp=sharing).
